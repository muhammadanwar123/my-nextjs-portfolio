...
const Navbar = ({isDarkMode, setIsDarkMode}) => {
  ...
  const [isScroll, setIsScoroll] = useState(false)
  ...
  return (
    <div>
      ...
      <nav className={`w-full fixed px-5 lg:px-8 xl:px-[8%] py-4 flex
        items-center justify-between z-40 ${isScroll ?
        ...
        <a href="#top">
          <Image
            ...
            width={200} 
            height={100} 
             className={`cursor-pointer mr-14 ${isDarkMode ? "filter invert" : ""}`}          />
               </a>

            <ul className={`hidden md:flex items-center gap-6 lg:gap-8 rounded-full px-12 py-3 ${isScroll ? "" : "bg-white shadwo-sm bg-opacity-50 dark:border dark:border-white/50 dark:bg-transparent"}`}>
